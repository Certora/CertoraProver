...
Program {
	Block 0_0_0_0_0_0 Succ [] {
		...
		AnnotationCmd:52 JSON{"key":{"name":"cvl.label.start","type":"report.calltrace.CVLReportLabel","erasureStrategy":"CallTrace"},"value":{"#class":"report.calltrace.CVLReportLabel.Message","s":"Assuming all requireInvariants commands globally"}}
		...
		AnnotationCmd:54 JSON{"key":{"name":"cvl.label.end","type":"java.lang.Integer","erasureStrategy":"Canonical"},"value":19}
		...
		AssertCmd:61 true "sanity bounds check on cvl to vm encoding failed (unsigned int)"
		...
		AssignExpCmd:63 I18:11 CANON16:18
		AssertCmd:61 true "sanity bounds check on cvl to vm encoding failed (unsigned int)"
		...
		AnnotationCmd:61 JSON{"key":{"name":"cvl.label.end","type":"java.lang.Integer","erasureStrategy":"Canonical"},"value":22}
