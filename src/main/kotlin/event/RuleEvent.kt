...
sealed class RuleEvent : EventBase<EventTopic.Rule>() {
    ...
    companion object {
        const val ASSERTS_NODE_TITLE = "Assertions"
        ...
        private fun SpecType.toRuleEventString(): String = when (this) {
            ...
            is SpecType.Single.GeneratedFromBasicRule.SanityRule -> {
                "Sanity-${
                    when (this) {
                        is SpecType.Single.GeneratedFromBasicRule.SanityRule.AssertionStructureCheck -> "AssertionStructure"
                        is SpecType.Single.GeneratedFromBasicRule.SanityRule.AssertTautologyCheck -> "AssertionTautology"
                        is SpecType.Single.GeneratedFromBasicRule.SanityRule.TrivialInvariantCheck -> "TrivialInvariant"
                        is SpecType.Single.GeneratedFromBasicRule.SanityRule.VacuityCheck -> "Vacuity"
                        is SpecType.Single.GeneratedFromBasicRule.SanityRule.RedundantRequireCheck -> "RedundantRequire"
                    }
                }"
            }
            ...
            is SpecType.Single.GeneratedFromBasicRule.MultiAssertSubRule -> {
                "MultiAssertCheck-${
                    when (this) {
                        is SpecType.Single.GeneratedFromBasicRule.MultiAssertSubRule.AutoGenerated -> "AutoGenAssert"
                        is SpecType.Single.GeneratedFromBasicRule.MultiAssertSubRule.SpecFile -> "CVLAssert"
                        is SpecType.Single.GeneratedFromBasicRule.MultiAssertSubRule.HashingBoundCheck -> "HashingBoundCheck"
                        is SpecType.Single.GeneratedFromBasicRule.MultiAssertSubRule.AssertsOnly -> ASSERTS_NODE_TITLE
                    }
                }"
            }
