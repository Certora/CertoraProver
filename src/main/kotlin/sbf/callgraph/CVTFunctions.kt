...
enum class CVTCore(val function: ExternalFunction) {
    ...
    RESTORE_SCRATCH_REGISTERS(ExternalFunction(CVT_restore_scratch_registers,
        writeRegister = SbfRegister.scratchRegisters.mapToSet { Value.Reg(it) },
        readRegisters = setOf())),
...
enum class CVTCalltrace(val function: ExternalFunction,
    ...
    PRINT_U64_AS_DECIMAL(CexPrintValue(CvlrFunctions.CVT_calltrace_print_u64_as_decimal, 4), setOf(CalltraceStr(SbfRegister.R1_ARG))),
