...
sealed class SnippetCmd: AmbiSerializable {
    ...
    sealed class EVMSnippetCmd : SnippetCmd() {
        ...
        @KSerializable
        sealed class CopyLoopSnippet: EVMSnippetCmd() {
            /**
             * Copy-Loop, generated by the Solidity compiler.
             */
            @KSerializable
            object CopyLoop : CopyLoopSnippet() {
     ...
     */
    @KSerializable
    sealed class LoopSnippet : SnippetCmd() {
    ...
    /**
     * Snippets which carry debug information from Rust.
     */
    @KSerializable
    sealed class CvlrSnippetCmd : SnippetCmd() {
         ...
         */
        @KSerializable
        data class CexPrint128BitsValue(
            val displayMessage: String,
            val low: TACSymbol.Var,
            val high: TACSymbol.Var,
            val signed: Boolean
        ) : CvlrSnippetCmd(), TransformableVarEntityWithSupport<CexPrint128BitsValue> {
        ...
        @KSerializable
        data class CexPrintLocation(val filepath: String, val lineNumber: UInt) : CvlrSnippetCmd()

        @KSerializable
        data class CexAttachLocation(val filepath: String, val lineNumber: UInt) : CvlrSnippetCmd()
